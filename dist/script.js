...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('sumbit', function (e) {
      e.preventDefault();
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["postDate"])(api, formDate).then(function (res) {
...
var mask = function mask(selecrot) {
...
var modals = function modals() {
  ...
  function openByScroll(selector) {
    window.addEventListener('scroll', function () {
      if (!btnPressed && window.pageYOffset + document.documentElement.clientHeight >= document.documentElement.scrollHeight) document.querySelector(selector).click();
    });
  }
...
var showMoreStyles = function showMoreStyles(trigger, styles) {
  var cards = document.querySelectorAll(styles),
      btn = document.querySelector(trigger); // cards.forEach(cards =>{
...
/*!*************************************!*\
  !*** ./src/js/services/requests.js ***!
  \*************************************/
/*! exports provided: postDate, getResourse */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
